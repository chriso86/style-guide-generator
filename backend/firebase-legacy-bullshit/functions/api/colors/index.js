...
exports.colorRouter = express.Router();
const db = connection_1.connection.firestore();
...
exports.colorRouter.post('/', function (req, res) {
...
exports.colorRouter.put('/', function (req, res) {
    // Set color object from DTO
    const color = req.body.color;
...
exports.colorRouter.get('/', function (req, res) {
